...
$fixCommit = "3123123"
$buildDefinitionName = "[P][Master][CI]"
$sourceCommit = ""

Write-Host $buildDefinitionName
.\script.ps1 -apiKey $apiKey -orgName $orgName -projectID $projectID -buildDefinitionName $buildDefinitionName -repositoryId $repositoryId -badCommit $badCommit -fixCommit $fixCommit -sourceCommit $sourceCommit